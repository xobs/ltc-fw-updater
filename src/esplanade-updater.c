...
#define PROG_STATR_ON   writel(1 << 5, GPIOA_PCOR)
#define PROG_STATR_OFF  writel(1 << 5, GPIOA_PSOR)
#define PROG_STATG_ON   writel(1 << 6, GPIOB_PCOR)
#define PROG_STATG_OFF  writel(1 << 6, GPIOB_PSOR)
